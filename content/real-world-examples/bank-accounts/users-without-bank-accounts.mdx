...
Next, we use `cy.intercept` to intercept the `POST` request to our GraphQL endpoint. We then determine if the `POST` request is a GraphQL query to "ListBankAccount." If so, we set the alias to `gqlListBankAccountQuery`. 
...
We then `.visit()` the `/bankaccounts` route.
...
![Users%20without%20Bank%20Accounts%20ef83fa2841d241efbfda7aa1b2bf4b6c/Screen_Shot_2021-06-30_at_1.17.05_PM.png](Users%20without%20Bank%20Accounts%20ef83fa2841d241efbfda7aa1b2bf4b6c/Screen_Shot_2021-06-30_at_1.17.05_PM.png)