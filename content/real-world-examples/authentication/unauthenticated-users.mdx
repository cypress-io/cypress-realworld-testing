...
![Screenshot of browser with Cypress command log showing passing test, shown as green, with the Real World App login page shown as the application under test.](/images/real-world-examples/authentication/unauthenticated-users/Screen_Shot_2021-06-28_at_1.35.44_PM.png)
