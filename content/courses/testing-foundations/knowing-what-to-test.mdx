...
We also highly recommend that you write tests around any bug that appears in your application. A good approach for this, is to first write a failing test around the bug before fixing it. Once the bug has been fixed your test will pass, which verifies that your new code has eliminated the bug.
