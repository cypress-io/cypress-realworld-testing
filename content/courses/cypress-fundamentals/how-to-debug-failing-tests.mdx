...
There are two useful ways to log information from your tests. One way is to use `cy.log()` the other is to use `console.log()` . Remember [Cypress is just JavaScript](/cypress-fundamentals/cypress-is-just-javascript) so you can leverage all of the helpful debugging techniques you use in JS too.
