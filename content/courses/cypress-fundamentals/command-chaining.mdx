...
You can learn more about command chaining in our [docs on chains of commands](https://docs.cypress.io/guides/core-concepts/introduction-to-cypress#Chains-of-Commands).
