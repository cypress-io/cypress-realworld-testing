...
- test the courses section on the home page and that the “get started” buttons link to the correct page
    - Assert the correct path/location
    - assert the correct h1 heading on the course page
    - After showing them the first test, have them write the next 2 tests as practice
        - provide the answers in the content in an accordion dropdown
- introduce the concept of user journeys and why they are useful
- write a user journey test
...
![Screen Shot 2022-07-12 at 8.25.04 AM.png](How%20to%20test%20multiple%20pages%20292651b5a740422da711797cf1123a92/Screen_Shot_2022-07-12_at_8.25.04_AM.png)

The “Get started” button links to the course page and provides more details about the lessons contained within that course. 

![screencapture-localhost-3000-testing-your-first-application-2022-07-12-08_25_51.png](How%20to%20test%20multiple%20pages%20292651b5a740422da711797cf1123a92/screencapture-localhost-3000-testing-your-first-application-2022-07-12-08_25_51.png)
...
![Screen Shot 2022-07-12 at 8.34.26 AM.png](How%20to%20test%20multiple%20pages%20292651b5a740422da711797cf1123a92/Screen_Shot_2022-07-12_at_8.34.26_AM.png)

Also, when you are running your tests in headless mode, which is how then will run in Continuous Integration, you will see the following in the output.

![Screen Shot 2022-07-12 at 8.36.33 AM.png](How%20to%20test%20multiple%20pages%20292651b5a740422da711797cf1123a92/Screen_Shot_2022-07-12_at_8.36.33_AM.png)
...
![Screen Shot 2022-07-12 at 8.50.32 AM.png](How%20to%20test%20multiple%20pages%20292651b5a740422da711797cf1123a92/Screen_Shot_2022-07-12_at_8.50.32_AM.png)

```html
<div data-test="course-0">
...
![Screen Shot 2022-07-12 at 8.57.15 AM.png](How%20to%20test%20multiple%20pages%20292651b5a740422da711797cf1123a92/Screen_Shot_2022-07-12_at_8.57.15_AM.png)

If we run our test, you will see that Cypress has found four `<a>` tags within the `<div data-test="course-0">` element. In a previous test, we used [eq](https://docs.cypress.io/api/commands/eq) to select a specific element from the returned array, inside of “the features on the homepage are correct” test.
...
So let’s update our test to use the eq command and select the last element in the array which is our button.

![Screen Shot 2022-07-12 at 9.00.12 AM.png](How%20to%20test%20multiple%20pages%20292651b5a740422da711797cf1123a92/Screen_Shot_2022-07-12_at_9.00.12_AM.png)
...
![Screen Shot 2022-07-12 at 9.01.18 AM.png](How%20to%20test%20multiple%20pages%20292651b5a740422da711797cf1123a92/Screen_Shot_2022-07-12_at_9.01.18_AM.png)
...
To sum all of this up, use `data` attributes whenever possible, otherwise, your tests can be quite brittle and break in the future.
...
![Screen Shot 2022-07-12 at 9.10.40 AM.png](How%20to%20test%20multiple%20pages%20292651b5a740422da711797cf1123a92/Screen_Shot_2022-07-12_at_9.10.40_AM.png)

Congrats! You have now learned how to write tests that span multiple pages.

## Final spec file

Here is the entire spec file so far:
...
![Screen Shot 2022-07-12 at 9.13.32 AM.png](How%20to%20test%20multiple%20pages%20292651b5a740422da711797cf1123a92/Screen_Shot_2022-07-12_at_9.13.32_AM.png)

It is always a good idea to re-run all of the tests in your spec file to make sure everything is still passing after you have finished writing a new test.
