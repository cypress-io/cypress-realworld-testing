...
Since we're getting back a list, we can use the [eq](https://docs.cypress.io/api/commands/eq) command to access a specific index in that list, which is exactly what we need.
