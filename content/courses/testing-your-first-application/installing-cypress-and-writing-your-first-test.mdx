...
:::info
If you do not see “Chrome” as an option, it isn't installed. You can [download Chrome](https://www.google.com/chrome/), then re-launch Cypress.
:::
...
To learn more, see our [dedicated lesson on command chaining](https://learn.cypress.io/cypress-fundamentals/command-chaining).
...
:::tip
To learn more, read our [best practices for selecting elements](https://on.cypress.io/best-practices#Selecting-Elements).
:::
