...
Since we're getting back multiple elements, we can use the [eq](https://on.cypress.io/eq) command to access a specific index among them, which is exactly what we need.
