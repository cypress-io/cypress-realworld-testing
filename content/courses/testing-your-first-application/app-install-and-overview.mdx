...
If you are not familiar with Git or don't have it installed, you can easily [download a zip file of the repo](https://github.com/cypress-io/cypress-realworld-testing-course-app).
