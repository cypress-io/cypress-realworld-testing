...
If you are familiar with Git and already have it installed the easiest way to clone [the repo](https://github.com/cypress-io/cypress-realworld-testing-course-app) is to run this command in your terminal.
...
If you are not familiar with Git or don't have it installed, you can easily download a zip file of the repo [here](https://github.com/cypress-io/cypress-realworld-testing-course-app).
