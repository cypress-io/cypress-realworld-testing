...
- Introduce Cypress custom commands
    - Show them how to write a custom command for getting `data-test` attributes more easily
    - Include an animated gif that visually shows how this custom command works
    - Refactor tests to use our custom command instead of classes and id’s
- Write a test for when a user successfully subscribes to our newsletter
- Discuss happy vs unhappy paths
- Write a test for when a user enters in a bad email
- Practice: Write a test for when a user has already subscribed to our newsletter
    - Give them some hints to get started
    - The solution to this test should be in the content but hidden in an accordion.
...
To do this, we can write our own [custom Cypress command](https://docs.cypress.io/api/cypress-api/custom-commands). A custom Cypress command is essentially just a function that we can use throughout our tests. What a custom command allows us to do is to reuse code or functionality across all of our Cypress spec files.
...
![Screen Shot 2022-07-11 at 9.17.04 AM.png](How%20to%20test%20forms%20&%20custom%20Cypress%20commands%208ae6d6d8890e4fff8d2c43eeac32e7f1/Screen_Shot_2022-07-11_at_9.17.04_AM.png)
...
[https://youtu.be/5F7t9IPoUvo](https://youtu.be/5F7t9IPoUvo)
...
To learn more you can [check out our docs](https://docs.cypress.io/api/cypress-api/custom-commands).

## Testing forms

One of the most common things you will find yourself writing tests for in any web application are forms. Since that is the case, we are going to spend the rest of this lesson discussing how to write tests for them. In our course application, in the hero section of the home page, we have a single input field and button that allows users to signup for our newsletter. 

![Screen Shot 2022-07-11 at 9.23.22 AM.png](How%20to%20test%20forms%20&%20custom%20Cypress%20commands%208ae6d6d8890e4fff8d2c43eeac32e7f1/Screen_Shot_2022-07-11_at_9.23.22_AM.png)
...
Notice that right off the bat, I am adding a `beforeEach()` hook which we discussed in the previous lesson. The reason for doing this is that I know every single test in this file is going to need to navigate to the homepage of our application since that is where this form is.
...
![Screen Shot 2022-07-11 at 10.09.18 AM.png](How%20to%20test%20forms%20&%20custom%20Cypress%20commands%208ae6d6d8890e4fff8d2c43eeac32e7f1/Screen_Shot_2022-07-11_at_10.09.18_AM.png)
...
![Screen Shot 2022-07-11 at 10.15.09 AM.png](How%20to%20test%20forms%20&%20custom%20Cypress%20commands%208ae6d6d8890e4fff8d2c43eeac32e7f1/Screen_Shot_2022-07-11_at_10.15.09_AM.png)
...
![Screen Shot 2022-07-11 at 10.17.20 AM.png](How%20to%20test%20forms%20&%20custom%20Cypress%20commands%208ae6d6d8890e4fff8d2c43eeac32e7f1/Screen_Shot_2022-07-11_at_10.17.20_AM.png)

After:

![Screen Shot 2022-07-11 at 10.17.23 AM.png](How%20to%20test%20forms%20&%20custom%20Cypress%20commands%208ae6d6d8890e4fff8d2c43eeac32e7f1/Screen_Shot_2022-07-11_at_10.17.23_AM.png)
...
![Screen Shot 2022-07-11 at 10.18.49 AM.png](How%20to%20test%20forms%20&%20custom%20Cypress%20commands%208ae6d6d8890e4fff8d2c43eeac32e7f1/Screen_Shot_2022-07-11_at_10.18.49_AM.png)
...
![Screen Shot 2022-07-11 at 10.23.32 AM.png](How%20to%20test%20forms%20&%20custom%20Cypress%20commands%208ae6d6d8890e4fff8d2c43eeac32e7f1/Screen_Shot_2022-07-11_at_10.23.32_AM.png)
...
![Screen Shot 2022-07-11 at 10.27.57 AM.png](How%20to%20test%20forms%20&%20custom%20Cypress%20commands%208ae6d6d8890e4fff8d2c43eeac32e7f1/Screen_Shot_2022-07-11_at_10.27.57_AM.png)

![Screen Shot 2022-07-11 at 10.28.38 AM.png](How%20to%20test%20forms%20&%20custom%20Cypress%20commands%208ae6d6d8890e4fff8d2c43eeac32e7f1/Screen_Shot_2022-07-11_at_10.28.38_AM.png)
...
![Screen Shot 2022-07-11 at 10.29.04 AM.png](How%20to%20test%20forms%20&%20custom%20Cypress%20commands%208ae6d6d8890e4fff8d2c43eeac32e7f1/Screen_Shot_2022-07-11_at_10.29.04_AM.png)
...
![Screen Shot 2022-07-11 at 10.31.42 AM.png](How%20to%20test%20forms%20&%20custom%20Cypress%20commands%208ae6d6d8890e4fff8d2c43eeac32e7f1/Screen_Shot_2022-07-11_at_10.31.42_AM.png)
...
![Screen Shot 2022-07-11 at 1.56.06 PM.png](How%20to%20test%20forms%20&%20custom%20Cypress%20commands%208ae6d6d8890e4fff8d2c43eeac32e7f1/Screen_Shot_2022-07-11_at_1.56.06_PM.png)
...
You need to use the email address “[john@example.com](mailto:john@example.com)” otherwise your test will not pass. 
