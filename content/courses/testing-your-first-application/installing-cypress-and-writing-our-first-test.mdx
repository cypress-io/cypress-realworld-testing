...
Reviewed By: Amir, Ben, Jordan, Kevin, Paul
Reviewed By Amir: August 11, 2021
Reviewed By Kevin: July 29, 2021
Section: Testing Your First App
...
Next we will add a custom npm script so we can launch Cypress easily. Within the `package.json` file add `"cypress:open": "cypress open"` to the `"scripts"` object. The entire `"scripts"` object should look like this:
...
![Screen Shot 2021-09-17 at 10.09.16 AM.png](Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-09-17_at_10.09.16_AM.png)
...
![Screen Shot 2021-09-17 at 10.09.40 AM.png](Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-09-17_at_10.09.40_AM.png)
...
![Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_9.47.49_AM.png](Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_9.47.49_AM.png)
...
![Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_9.56.26_AM.png](Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_9.56.26_AM.png)
...
![Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.02.58_AM.png](Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.02.58_AM.png)
...
Therefore we can `get` this element like so:
...
![Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.20.05_AM.png](Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.20.05_AM.png)

Now click on the `app.spec.js` file to launch the file containing our test. 

You should see an error like this:

![Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.20.58_AM.png](Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.20.58_AM.png)

Cypress is telling us that it is unable to `get` our input element with the class of `.new-todo`. If you look at the right side of Cypress, you will see a message that says, "This is the default blank page," with some hints about what to do. This is just a blank page that Cypress opens when it doesn't know where to go, but we want Cypress to open our todo application. Let's go back to our test and tell Cypress how to `.navigate()` to our app. 
...
![Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.25.30_AM.png](Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.25.30_AM.png)
...
Next, we need to enter the name of our todo. We can do that using the `.type()` method and passing in a string of what we would like Cypress to type into the input.
...
![Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.27.18_AM.png](Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.27.18_AM.png)
...
By adding `{enter}` inside of our `.type()` function, Cypress will press the enter key after it has finished typing "Buy Milk"

![Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.29.13_AM.png](Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.29.13_AM.png)
...
![Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.37.43_AM.png](Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.37.43_AM.png)
...
![Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.39.45_AM.png](Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.39.45_AM.png)

![Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.40.23_AM.png](Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.40.23_AM.png)
...
![Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.48.50_AM.png](Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.48.50_AM.png)
...
![Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.51.41_AM.png](Installing%20Cypress%20and%20writing%20our%20first%20test%20bcfdcfbf7c1d4b868cab1a315e8072f4/Screen_Shot_2021-06-25_at_10.51.41_AM.png)