...
We have an extensive guide covering everything you need to know about using Cypress in CI. You can read the [Continuous Integration guide](https://docs.cypress.io/guides/continuous-integration/introduction).
...
[Cypress Cloud](https://www.cypress.io/cloud/) increases test velocity while giving total visibility into tests running in your CI pipeline. It also provides automatic parallelization and load balancing, so your tests run incredibly fast.
