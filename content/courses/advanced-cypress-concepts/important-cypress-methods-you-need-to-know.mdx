...
If you would like to practice using some of these Cypress methods, we have created the [cypress-realworld-testing-blog repository](https://github.com/cypress-io/cypress-realworld-testing-blog). The installation instructions are located in the **README.md** file.
