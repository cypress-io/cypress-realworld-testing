...
[Cypress is just JavaScript](https://www.notion.so/cypress-is-just-javascript-685fed9dbc674ee8b0150d5b67dac0d7), and the `.invoke()` method allows you to call JS functions on JS data types.
