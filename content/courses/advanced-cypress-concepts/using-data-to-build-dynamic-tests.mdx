...
Ready for Review: No
Reviewed By: Kevin
Reviewed By Kevin: September 23, 2021
Section: Advanced Cypress Concepts
Status: Migrated
Title Approved: Yes

In the lesson [Database Initialization & Seeding](Database%20Initialization%20&%20Seeding%2012d7ce44bc424a3688a7839a7c7cef79.md), we give you several strategies for creating the data necessary for your tests. In this lesson, we will help you better understand how to use that data to drive your tests.
...
It is best to use hard-coded data for your tests.
