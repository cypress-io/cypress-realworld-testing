...
![](/images/tutorials/next-js-and-shopify-store/running-our-tests-in-parallel-with-cypress-dashboard/Screen_Shot_2021-12-17_at_9.25.02_AM.png)

Give your project a name and select GitHub Actions as the CI provider.

![](/images/tutorials/next-js-and-shopify-store/running-our-tests-in-parallel-with-cypress-dashboard/Screen_Shot_2021-12-17_at_9.25.51_AM.png)
...
![](/images/tutorials/next-js-and-shopify-store/running-our-tests-in-parallel-with-cypress-dashboard/Screen_Shot_2021-12-17_at_9.26.57_AM.png)

Then we will need to copy the record key and add it to GitHub secrets.

![](/images/tutorials/next-js-and-shopify-store/running-our-tests-in-parallel-with-cypress-dashboard/Screen_Shot_2021-12-17_at_9.28.22_AM.png)

![](/images/tutorials/next-js-and-shopify-store/running-our-tests-in-parallel-with-cypress-dashboard/Screen_Shot_2021-12-17_at_9.28.34_AM.png)

![](/images/tutorials/next-js-and-shopify-store/running-our-tests-in-parallel-with-cypress-dashboard/Screen_Shot_2021-12-17_at_9.29.12_AM.png)
...
![](/images/tutorials/next-js-and-shopify-store/running-our-tests-in-parallel-with-cypress-dashboard/Screen_Shot_2021-12-17_at_9.36.28_AM.png)
...
![](/images/tutorials/next-js-and-shopify-store/running-our-tests-in-parallel-with-cypress-dashboard/Screen_Shot_2021-12-17_at_9.41.53_AM.png)

After clicking on it, you can then inspect the test results.

![](/images/tutorials/next-js-and-shopify-store/running-our-tests-in-parallel-with-cypress-dashboard/Screen_Shot_2021-12-17_at_9.42.36_AM.png)
...
![](/images/tutorials/next-js-and-shopify-store/running-our-tests-in-parallel-with-cypress-dashboard/Screen_Shot_2021-12-17_at_10.09.51_AM.png)

Once the install job is complete our tests will be run in parallel on multiple machines.

![](/images/tutorials/next-js-and-shopify-store/running-our-tests-in-parallel-with-cypress-dashboard/Screen_Shot_2021-12-17_at_10.13.33_AM.png)

All of our tests are passing and finished in a fraction of the time since we have them running in parallel now.

![](/images/tutorials/next-js-and-shopify-store/running-our-tests-in-parallel-with-cypress-dashboard/Screen_Shot_2021-12-17_at_1.36.55_PM.png)
