...
![Screenshot of GitHub Fork Button](/images/testing-your-first-application/todomvc-install-and-overview/Screen_Shot_2021-06-24_at_10.46.38_AM.png)
...
![Screenshot of GitHub Forked Repo](/images/testing-your-first-application/todomvc-install-and-overview/Screen_Shot_2021-06-24_at_10.54.13_AM.png)
...
![Screenshot of GitHub Clone Button](/images/testing-your-first-application/todomvc-install-and-overview/Screen_Shot_2021-06-24_at_10.55.46_AM.png)
...
You can then open your browser to [`http://localhost:8888`](http://localhost:8888/) and you should see the following:

![Screenshot of TodoMVC Home App](/images/testing-your-first-application/todomvc-install-and-overview/Screen_Shot_2021-06-24_at_1.08.11_PM.png)

## App Overview

![Screenshot of TodoMVC Home App with three todos added](/images/testing-your-first-application/todomvc-install-and-overview/Screen_Shot_2021-06-24_at_1.14.12_PM.png)
