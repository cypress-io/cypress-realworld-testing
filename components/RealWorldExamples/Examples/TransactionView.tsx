...
export default function ExamplesLayout({ examples }) {
  return (
    <section data-test={`real-world-example-transaction-view`}>
      <div className={`grid grid-cols-2 gap-8 p-16 h-full bg-indigo-100`}>
        <div className="w-6/12 mx-auto">
          <h3
            ...
            data-test={`transaction-view-title`}
          >
            {examples.title}
          </h3>
                  ...
                  <div className="flex-1 p-6 flex flex-col justify-between">
                    <div className="flex-1">
                      <p
                        ...
                        data-test={`transaction-view-${indx}-title`}
                      >
                        {example.title}
                      </p>
                      <p
                        className={`mt-3 text-base text-gray-600`}
                        data-test={`transaction-view-${indx}-description`}
                      >
                        {example.description}
                      </p>
                    </div>
