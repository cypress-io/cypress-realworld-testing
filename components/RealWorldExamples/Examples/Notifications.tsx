...
export default function ExamplesLayout({ examples }) {
  return (
    <section data-test={`real-world-example-notifications`}>
                  ...
                  <div className="flex-1 p-6 flex flex-col justify-between">
                    <div className="flex-1">
                      <p
                        ...
                        data-test={`notifications-${indx}-title`}
                      >
                        {example.title}
                      </p>
                      <p
                        className={`mt-3 text-base text-gray-600`}
                        data-test={`notifications-${indx}-description`}
                      >
                        {example.description}
                      </p>
                    </div>
