import TutorialLessonBreadcrumbs from "./TutorialLessonBreadcrumbs"
...
const RWELessonSidebar = dynamic(() => import("./TutorialLessonSidebar"), {
  ssr: false,
})
...
export default function LessonLayout({
  ...
  return (
    <>
      <TutorialLessonBreadcrumbs lessonData={lessonData} />
          ...
          <div className="mx-auto max-w-3xl sm:px-6 lg:grid lg:max-w-full lg:grid-cols-12 lg:gap-8 lg:px-8">
            ...
            <div className="lg:col-span-3 xl:col-span-2">
              <div className="sticky top-6">
                <p className="mb-4 font-semibold">Tutorial Lessons</p>
